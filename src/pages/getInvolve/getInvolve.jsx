...
const GetInvolve = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-['Inter',_sans-serif] text-black">
      ...
      <div className="px-4 max-w-[393px] md:max-w-none md:container md:mx-auto md:px-8 pb-20">
        ...
        <div className="flex flex-col gap-[70px] md:gap-[120px]">
          ...
          <section className="text-left grid md:grid-cols-2 md:gap-20 md:items-center">
            ...
            <div className="relative w-full aspect-[4/3] mt-4 md:mt-0 overflow-hidden rounded-sm order-2 md:order-2">
              <img 
                src={volunteerImg} 
          ...
          <section className="text-center md:text-left grid md:grid-cols-2 md:gap-20 md:items-center">
            ...
            <div className="relative w-full aspect-[4/3] mb-4 md:mb-0 overflow-hidden rounded-sm order-2 md:order-1">
              <img 
                src={partnerImg} 
          ...
          <section className="text-left grid md:grid-cols-2 md:gap-20 md:items-center">
            ...
            <div className="relative w-full aspect-[4/3] mb-6 md:mb-0 overflow-hidden rounded-sm order-1 md:order-2">
              <img 
                src={benefitsImg} 
