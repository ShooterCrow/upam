    ...
    <>
      {newTab ? (
        <a
          ...
          className="cursor-pointer flex items-center gap-2 text-sm font-medium text-upam-red hover:text-upam-red/80 transition-colors group"
        >
          {text}
        ...
        <ScrollReveal direction="up">
          <div className="space-y-6 lg:space-y-8">
            ...
            <p className="text-[#555555] text-base md:text-lg lg:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
              This call invites every African, at home and in the diaspora, to
              embrace a future where our combined strength becomes the
              foundation for lasting development.
            </p>
  ...
  const focusAreas = [
    {
      ...
      description:
        "Fostering collaboration and shared growth across the continent to build a stronger, more integrated Africa.",
      image: "/africa_unity.png",
    },
    {
      title: "Africa's Independence",
      description:
        "Promoting economic self-reliance and political sovereignty for all African nations.",
      image: "/africa_independence.png",
    },
    {
      title: "Education & Leadership",
      description:
        "Investing in the next generation of African leaders through quality education and mentorship.",
      image: "/education_leadership.png",
    },
    {
      title: "Security & Stability",
      description:
        "Ensuring peace and safety within African communities and states for sustainable development.",
              ...
              <div className="flex flex-col gap-12">
                <div className="space-y-8">
                  <div className="space-y-4">
                    ...
                    <p className="text-base text-[#555555] leading-relaxed font-medium">
                      To strengthen bonds of solidarity between all people of
                      African descent, fostering unity and development in
                      Africa; for enhanced independence, industrialization,
                      economic self- reliance as well as promote peace, security
                      and stability within African communities and states.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  <div className="space-y-4">
                    ...
                    <p className="text-base text-[#555555] leading-relaxed font-medium">
                      A United Africa for sustainable development for all
                      Africans Descent. UPAM is a continental evolution and an
                      all-African organization, seeking to enhance the
                      unification of African nations as a whole and reclaiming
                      its hope for the destined future.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                <div className="order-2 lg:order-1 flex flex-col gap-8">
                  <div className="flex flex-col gap-4">
                    ...
                    <p className="text-base text-[#555555] leading-relaxed font-medium">
                      This call invites every African, at home and in the
                      diaspora, to embrace a future where our combined strength
                      becomes the foundation for lasting development.
                    </p>
                  </div>
                  <div>
                    <WorldMapWithMarkers />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                ...
                <div className="flex flex-col gap-8">
                  <div className="flex flex-col gap-4">
                    ...
                    <p className="text-base text-[#555555] leading-relaxed font-medium">
                      UPAM is a continental evolution and an all-African
                      organization, seeking to enhance the unification of
                      African nations as a whole and reclaiming its hope for the
                      destined future.
                    </p>
                    <p className="text-base text-[#555555] leading-relaxed font-medium mb-4">
                      To encourage and strengthen bonds of solidarity between
                      all people of African descent, Foster the development and
                      unity of Africa, to enhanced independence.
                    </p>
                    <div className="w-fit">
              ...
              <div className="bg-[#003115] py-16 px-8">
                <div className="grid grid-cols-2 lg:grid-cols-4 divide-y-2 lg:divide-y-0 lg:divide-x divide-white/10">
                  {[
                    {
                      value: "50+",
                      label: "Countries & Chapters",
                      desc: "A growing global network across Africa and the diaspora",
                    },
                    {
                      value: "200+",
                      label: "Lives Impacted",
                      desc: "Lives impacted by UPAM programs and initiatives",
                    },
                    {
                      value: "10+",
                      label: "Countries Reached",
                      desc: "Countries impacted meaningfully by UPAM",
                    },
                    {
                      value: "800+",
                      label: "Volunteers",
                      desc: "The organisation thrived on the remarkable dedication of over 800 volunteers",
                    },
                  ].map((stat, i) => (
                    <ScrollReveal key={i} direction="up" delay={i * 0.1}>
                      <div className="text-center px-6 py-8 lg:py-4">
                        <p className="text-4xl md:text-5xl lg:text-6xl font-black text-[#EB010C] mb-2">
                          {stat.value}
                        </p>
                        <p className="text-white font-black text-xs uppercase tracking-widest mb-2">
                          {stat.label}
                        </p>
                        <p className="text-white/60 text-xs leading-relaxed max-w-[180px] mx-auto">
                          {stat.desc}
                        </p>
                      </div>
                    </ScrollReveal>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {focusAreas.map((area, index) => (
                        ...
                        >
                          ...
                          <span
                            className={`text-sm font-black uppercase tracking-tight flex-1 px-4 text-left`}
                          >
                            {area.title}
                          </span>
                          <div
                            className={`w-2 h-2 ${activeFocus === index ? "bg-[#EB010C] animate-pulse" : "bg-slate-200"}`}
                          />
                        </button>
                      ))}
                    </div>
          ...
          <section className="flex flex-col items-center gap-16 lg:gap-24 mb-24 lg:mb-32">
            <div className="flex flex-col items-center gap-6 max-w-4xl text-center">
              ...
              <p className="text-lg text-[#555555] font-medium max-w-2xl px-6">
                Moments of unity, culture, advocacy, and community impact
                captured across Africa and the diaspora.
              </p>
            </div>
            ...
            <section className="mb-24 lg:mb-32">
              <div className="flex flex-col gap-6 mb-16 text-center lg:text-left">
                ...
                <p className="text-lg text-[#555555] font-medium max-w-2xl">
                  Transforming lives across the continent through sustainable
                  development, financial inclusion, and educational excellence.
                </p>
              </div>
              ...
              <div className="max-w-xl lg:ml-0">
                <div className="space-y-4 relative z-10">
                  ...
                  <p className="text-base text-white/70 leading-relaxed font-medium">
                    We the African People Stand United for Economically
                    Self-sustainable Development, Freedom, Equality, Justice,
                    Free Trade, Open Borders, and the Protection of Our
                    motherland.
                  </p>
                </div>
              ...
              <div className="w-full relative">
                ...
                <div className="relative overflow-hidden py-4 w-full">
                  ...
                  <div
                    ...
                    }} /* 🚀 SPEED CONTROL: Change '22s' to make it faster (e.g. '15s') or slower (e.g. '40s') */
                  >
                    ...
                    {globalExecutive.map((leader, index) => (
                      ...
                      >
                        ...
                        <div className="flex flex-col text-left px-1">
                          <h4
                            className="text-[#555555] font-bold text-sm sm:text-base leading-snug group-hover:text-[#EB010C] transition-colors duration-200"
                            translate="no"
                          >
                            {leader.name}
                          </h4>
                ...
                <div className="flex flex-col gap-2 max-w-2xl">
                  ...
                  <div className="flex flex-col gap-3">
                    <p className="text-[#555555] leading-relaxed">
                      Stay updated with UPAM activities, announcements, and
                      Pan-African happenings throughout the year.
                    </p>
                  </div>
                </div>
                ...
                {eventsLoading ? (
                  ...
                  <div className="lg:col-span-3 text-center py-20 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
                    <p className="text-[#555555] font-medium">
                      No recent activities or events found.
                    </p>
                  </div>
                ) : (
                  <>
                    ...
                    <div className="lg:col-span-2">
                      {events[0] && (
                        <Link
                          to={`/events/${events[0]._id}`}
                          className="relative h-[530px] border border-slate-100 overflow-hidden group cursor-pointer block bg-black"
                        >
                          <img
                            src={
                              events[0].image
                                ? events[0].image.startsWith("http")
                                  ? events[0].image
                                  : `http://localhost:5000/${events[0].image}`
                                : "/academy_logo.png"
                            }
                            alt={events[0].title}
                    ...
                    <div className="flex flex-col gap-6">
                      {events.slice(1, 3).map((event) => (
                        <Link
                          key={event._id}
                          to={`/events/}`}
                          className="flex-1 border-none flex flex-col group transition-all duration-500"
                        >
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6 mb-16">
              <div className="space-y-4">
                ...
                <p className="text-lg text-[#555555] font-medium max-w-xl">
                  Trusted Pan-African news curated for an informed and empowered
                  continent.
                </p>
              </div>
              <div className="pb-2">
                <ReadMore
                  link={"http://wnn.africa/"}
                  newTab={true}
                  text={"Visit WNN Africa"}
                />
              </div>
            </div>
              ...
              {[
                {
                  ...
                  image:
                    "https://wnn.africa/wp-content/uploads/2025/12/Mohammed-Badaru-Abubakar-Nigeria-Defence-Minister.jpeg",
                ...
                },
                {
                  ...
                  image:
                    "https://wnn.africa/wp-content/uploads/2025/04/Africa-Climate.jpeg",
                ...
                },
                {
                  ...
                  image:
                    "https://wnn.africa/wp-content/uploads/2025/05/Ukraine-US-.jpeg",
                ...
                <a
                  ...
                  rel="noreferrer"
                  key={index}
                  className="group flex flex-col gap-8 bg-white border border-transparent hover:border-slate-100 transition-all duration-500"
                >
