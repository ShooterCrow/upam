...
// How UPAM Works - 4 steps
export const howItWorksSteps = [
  {
    number: 1,
    title: "Create Event",
    description:
      "Share your event with a Pan-African audience by providing event details, dates, location, and ticket information.",
  },
  {
    number: 2,
    title: "Publish & Promote",
    description:
      "Once published, your event becomes visible on the platform where people can discover and share it.",
  },
  {
    number: 3,
    title: "Sell Tickets",
    description:
      "Set ticket prices, manage availability, and receive payments securely.",
  },
  {
    number: 4,
    title: "Host & Connect",
    description:
      "Host your event, connect with your audience, and build lasting impact.",
  },
];
...
export const events = [
  {
    ...
    highlights: [
      {
        title:
          'DAY 1 : HEALTH SYMPOSIUM – "Rising Above Influence: The Power of Purpose"',
  ...
  },
  {
    ...
    fullDescription:
      "A flagship conference celebrating Pan-African unity, impact, and sustainability. Join leaders and communities from across the continent and the diaspora.",
    status: "upcoming",
  },
  {
    id: 4,
    ...
    fullDescription:
      "A week-long program celebrating women and equipping them with practical skills for sustainable livelihoods.",
    status: "upcoming",
  },
  {
    id: 5,
    ...
    location: "TBD",
    description:
      "We're excited to announce the launch of Upam Academy, where learning meets innovation. Join us for an exclusive event as we unveil our programs and opportunities for growth.",
    image:
  ...
  },
  {
    ...
    description:
      "A gathering of young leaders from across Africa and the diaspora to discuss unity, development, and collective action.",
    image:
      "https://images.unsplash.com/photo-1540575467063-178bf50e2f0a?w=800&q=80",
    fullDescription:
