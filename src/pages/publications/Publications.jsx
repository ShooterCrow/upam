    ...
    const articles = [
        {
            ...
            path: "/research/panafrican-unity"
        },
        {
            ...
            path: "/research/digital-literacy"
        },
        {
                        ...
                        {articles.map((article, index) => (
                            ...
                            >
                                ...
                                <div className="p-6 flex flex-col flex-grow">
                                    ...
                                    <Link to={article.path} className="inline-flex items-center text-red-600 hover:text-red-700 font-medium text-sm transition-colors group">
                                        Read more
