...
const DonationPaymentModal = ({ isOpen, onClose, amount, onSuccess, donorInfo }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div
                className="bg-white shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200"
                role="dialog"
                aria-modal="true"
            >
                {/* Header */}
                ...
                <div className="p-8 text-center">
                    ...
                    <button
                        ...
                        disabled={isProcessing}
                        className="w-full bg-[#EB010C] text-white py-3 font-semibold text hover:bg-red-700 transition-colors flex justify-center items-center disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                        {isProcessing ? (
